...
plot_launch_slotted = heatmap_plot(output_data_melted, "lSlotted", "Constellation launches", leftmost=TRUE)
plot_launch_unslotted = heatmap_plot(output_data_melted, "lUnslotted", "Fringe launches", leftmost=TRUE)
